...
## Phase Completion Gate (MANDATORY before Final Steps)

**KNOWN BUG (2026-05-21):** LLM consistently skips Phase 4 (REVIEW) in
autonomous mode, even after explicit reminders. This gate prevents that.

Before marking a feature as done, verify ALL artifacts exist:

```
REQUIRED — feature is NOT done without these:
  ...
  ✅ docs/features/<feature>/review-report.md      — Phase 4  ← MOST SKIPPED

IF review-report.md is MISSING:
  Phase 4 was skipped. Run brutal-honesty-review NOW.
  DO NOT proceed to Final Steps.

IF any Phase 1 doc is MISSING:
  Phase 1 was skipped. Run sparc-prd-mini NOW.
  Then re-run Phase 2 validation.
```
